...
export interface ApiEndowmentEndowment extends Struct.SingleTypeSchema {
  collectionName: 'endowments';
  info: {
    displayName: '\u042D\u043D\u0434\u0430\u0443\u043C\u0435\u043D\u0442';
  ...
  attributes: {
    ...
    donors: Schema.Attribute.Component<'endowment-blocks.donor', true>;
    donors_count: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    team: Schema.Attribute.Component<'endowment-blocks.team', true>;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Contacts: Schema.Attribute.Component<'blocks.contacts', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Gifts: Schema.Attribute.Component<'blocks.gift', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    Partners: Schema.Attribute.Component<'blocks.partner', true>;
    publishedAt: Schema.Attribute.DateTime;
    Resources: Schema.Attribute.Component<'blocks.ssylka', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMemoryMemory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Graduate_year: Schema.Attribute.Integer &
      Schema.Attribute.Required &
...
export interface ApiNewsNews extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Content_img: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiYearYear extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Classes: Schema.Attribute.Component<'blocks.class', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
